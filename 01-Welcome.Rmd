...
Providing you with rules and procedures is to ensure that current efforts build on past success and failures. Novel arrivals should not need to re-invent anything, you should not be starting your experiments from scratch, but build on what previous researchers have already achieved.
